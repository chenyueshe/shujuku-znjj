var vue=new Vue({
	...
	data:{
		...
		uploadUrl:urlAdd+"/uploadsensorURL",
	...
	methods:{
		...
		queryInfoList:function(){
			...
			var url=urlAdd+'/querysensorList';
		...
		submitUpload:function() {//文件上传
	        var FormData={};
	        var url=urlAdd+'/uploadsensorFile';
	        this.$http.post(url,FormData,{emulateJSON:true}).then(function(res){
				if("S"==res.body.status){
					this.$message({
	    ...
	    formatDate:function(row, column, cellValue, index) {
	      ...
	      downloadInfo:function(){
	        ...
	        elemIF.src = urlAdd+"/downloadkhyjReport?"+"roomId="+FormData.roomId+"&roomName="+FormData.roomName+"&lastNum="+FormData.lastNum
