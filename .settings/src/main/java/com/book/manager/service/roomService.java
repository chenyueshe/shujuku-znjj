...
public interface roomService{
	...
	public ResponseMessage addroom(@RequestBody RoomVo param, BindingResult bindingResult);
	public ResponseMessage deleteroom(Map<String,Object> param);
	public ResponseMessage updateroom(@RequestBody RoomVo param, BindingResult bindingResult);
